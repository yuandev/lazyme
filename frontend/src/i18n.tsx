...
const en = {
  ...
  deleteWarn: 'This will stop the service and remove all config.',
  deleting: 'Stopping service...',
  deletingDone: 'Service stopped',
  deletingClean: 'Removing config...',
  rename: 'rename',
  renameTitle: 'Rename {name}',
  newName: 'New name:',
  newTarget: 'Add Target',
  createTarget: 'Create',
  repoPath: 'Repo path (must exist on server):',
  gitRemote: 'Git remote URL (optional, will clone):',
...
const zh: typeof en = {
  ...
  delete: '删除',
  deleteTitle: '删除 {name}？',
  deleteWarn: '将停止服务并删除所有配置。',
  deleting: '正在停止服务...',
  deletingDone: '服务已停止',
  deletingClean: '正在删除配置...',
  rename: '改名',
  renameTitle: '重命名 {name}',
  newName: '新名称:',
  newTarget: '新增配置',
  createTarget: '创建',
  repoPath: '仓库路径（服务器上必须存在）:',
  gitRemote: 'Git 远程地址（可选，将自动 clone）:',
  configPath: '{repo}/.deployd/config.toml',
  viteConfigPath: '{repo}/vite.config.ts',
  errorPrefix: '错误:',
  seconds: '秒',
